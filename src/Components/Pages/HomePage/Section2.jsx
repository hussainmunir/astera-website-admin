...
const Section2 = () => {
	...
	const { getRootProps, getInputProps } = useDropzone({ onDrop });
     ...
     const [fontWeight, setFontWeight] = useState("normal"); // Default to regular font weight
				...
				<div className="flex mt-[2rem]">
					...
					<div className="flex flex-col">
						<div className="flex items-center mb-4">
							...
							<select
								className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:border-black mr-4"
							...
							{/* Bold Button */}
							<button
								className={`rounded-lg border border-gray-300 px-3 py-1 focus:outline-none mr-2 ${
									isBold ? "font-bold" : ""
								}`}
								onClick={toggleBold}
							>
							...
							{/* Italic Button */}
							<button
								className={`rounded-lg border border-gray-300 px-3 py-1 focus:outline-none ${
									isItalic ? "italic" : ""
								}`}
