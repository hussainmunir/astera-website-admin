    ...
    const fetchData = async () => {
      try {
        ...
        if (
          response.data &&
          response.data.data &&
          response.data.data.privacyPolicyPage
        ) {
          const privacyPolicyPage = response.data.data.privacyPolicyPage;
          if (privacyPolicyPage.section1) {
            const { section1 } = privacyPolicyPage;
